...
SPEC_008A_DEPENDENCY_ADOPTION_STATE = CANONICAL_QUALIFIED
...
SPEC_008A_DEPENDENCY_ADOPTION_ACCEPTED_HEAD = f0009d0eceee7d5d1d0acc507122686215ab5b6b
SPEC_008A_DEPENDENCY_ADOPTION_PREMERGE_CI = 35646948025_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008A_DEPENDENCY_ADOPTION_PREMERGE_R3 = 35646948045_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008A_DEPENDENCY_ADOPTION_CANONICAL_MERGE = c1ad38d2dd151ceb0139ec7fd7caf2c4a337ed4c
SPEC_008A_DEPENDENCY_ADOPTION_MERGE_PARENT_1 = c2b4bb54cb72014d3784d925d7e4433783b0a18b
SPEC_008A_DEPENDENCY_ADOPTION_MERGE_PARENT_2 = f0009d0eceee7d5d1d0acc507122686215ab5b6b
SPEC_008A_DEPENDENCY_ADOPTION_MERGE_TREE = a79615b1508cb2543ee81678175c793a1a49694a_EQUALS_ACCEPTED_TREE
SPEC_008A_DEPENDENCY_ADOPTION_POSTMERGE_CI = 35649474044_SUCCESS_PUSH_ATTEMPT_1
SPEC_008A_DEPENDENCY_ADOPTION_POSTMERGE_R3 = 35649473639_SUCCESS_PUSH_ATTEMPT_1
SPEC_008A_DEPENDENCY_ADOPTION_REVIEW_RECONCILIATION = NO_SUBMITTED_REVIEWS_ZERO_THREADS_OCR_DELEGATED_NO_BLOCKING_FINDING
SPEC_008A_DEPENDENCY_ADOPTION_SUPERSEDED_PR = 204_CLOSED_UNMERGED_RECORDED_BASE_CANNOT_FOLLOW_TRUSTED_GATE
B008A_GATE_HARDENING_CANONICAL_MERGE = c2b4bb54cb72014d3784d925d7e4433783b0a18b
B008A_GATE_HARDENING_PREMERGE_CI = 35643377757_SUCCESS_PULL_REQUEST_ATTEMPT_1
...
SPEC_008B_GRAIN1_CORE_STATE = CANONICAL_QUALIFIED
...
SPEC_008B_GRAIN1_ACCEPTED_HEAD = 1adf8df2042fb6f8e2e41076ad65a0cd3b5f1761
SPEC_008B_GRAIN1_PREMERGE_CI = 35660734731_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008B_GRAIN1_PREMERGE_R3 = 35660734833_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008B_GRAIN1_CANONICAL_MERGE = f69ada64895d68779276d7eb6660564c6825aaa8
SPEC_008B_GRAIN1_MERGE_PARENT_1 = 5787979e6dc62c7a4454c83aadbdc77623a3fe3a
SPEC_008B_GRAIN1_MERGE_PARENT_2 = 1adf8df2042fb6f8e2e41076ad65a0cd3b5f1761
SPEC_008B_GRAIN1_MERGE_TREE = a15c1ad3d31e534200e7cfafb9a8fc29a3329433_EQUALS_ACCEPTED_TREE
SPEC_008B_GRAIN1_POSTMERGE_CI = 35662990699_SUCCESS_PUSH_ATTEMPT_1
...
SPEC_008C_GRAIN1_STATE = CANONICAL_QUALIFIED
...
SPEC_008C_GRAIN1_ACCEPTED_HEAD = 91d32333c5bda1bd4744418e750112410321169a
SPEC_008C_GRAIN1_FAILED_HEAD = 1bfc95606949e184d2fe58fb50294a9f68df3335_PRESERVED_RUN_35667753768
SPEC_008C_GRAIN1_PREMERGE_CI = 35668523429_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008C_GRAIN1_PREMERGE_R3 = 35668523396_SUCCESS_PULL_REQUEST_ATTEMPT_1
SPEC_008C_GRAIN1_CANONICAL_MERGE = 89934e0efa38416c14018acded7e07be21657109
SPEC_008C_GRAIN1_MERGE_PARENT_1 = 39685d482127c967f7b140b3696e265ed9db13a0
SPEC_008C_GRAIN1_MERGE_PARENT_2 = 91d32333c5bda1bd4744418e750112410321169a
SPEC_008C_GRAIN1_MERGE_TREE = d2211751631c10993f568012d1ab519fa01edefe_EQUALS_ACCEPTED_TREE
SPEC_008C_GRAIN1_POSTMERGE_CI = 35669970610_SUCCESS_PUSH_ATTEMPT_1
...
## Specification 008A adoption closeout and grain 1 (Windows microphone adapter core)

The Windows-only `cpal 0.18.2` target edge is `CANONICAL_QUALIFIED`
through two recorded units: the trusted gate hardening (PR #205, merge
`c2b4bb54cb72014d3784d925d7e4433783b0a18b`, pre-merge CI `35643377757` /
R3 `35643377577`, post-merge CI `35645592708` / R3 `35645592747`) and the
adoption (PR #206, accepted head `f0009d0eceee7d5d1d0acc507122686215ab5b6b`,
pre-merge CI `35646948025` / R3 `35646948045`, merge
`c1ad38d2dd151ceb0139ec7fd7caf2c4a337ed4c` with parents
`c2b4bb5` + `f0009d0`, merge tree
`a79615b1508cb2543ee81678175c793a1a49694a` equal to the accepted head tree,
post-merge CI `35649474044` / R3 `35649473639`). PR #204 is preserved as
the closed, unmerged original candidate record because a pull request's
recorded comparison base cannot follow a base-branch move
(run `35645749583`); its `windows-latest` job `106471568452` already
proved the identical content on Windows. Nothing was rewritten.

Grain 1 adds the portable Windows microphone adapter core in
`capture_windows.rs` (registered in `lib.rs`): OS endpoint-id identity,
selection precedence, the Windows fault taxonomy, the 006A start/runtime
mappings, the 006B reason, injected-backend tests, and privacy-revocation
telemetry proof. It makes no OS call and references no `cpal` item, so
Linux/macOS behavior is untouched and every test runs on all three CI
hosts. Two deliberate divergences from 007A are recorded in
`008a-windows-microphone-core-evidence.md`: identity from the OS endpoint
id rather than the display name, and `preferred_config = None` instead of
mislabelling an unmodelled format F32. A reroute is not a fault (no
machine event, no health reason), and a test keeps the event and health
...
`008b-system-audio-core-evidence.md` is the controlling record.

## Specification 008B grain 2 (cpal/WASAPI loopback binding)

Grain 1 is `CANONICAL_QUALIFIED`: PR #209 accepted head
`1adf8df2042fb6f8e2e41076ad65a0cd3b5f1761` passed pre-merge CI
`35660734731` / R3 `35660734833` on attempt 1 with ubuntu (9m54s), macOS
(5m20s), and Windows (18m9s) all SUCCESS, merged as
`f69ada64895d68779276d7eb6660564c6825aaa8` with parents `5787979` +
`1adf8df`, merge tree `a15c1ad3d31e534200e7cfafb9a8fc29a3329433` equal to
the accepted head tree, signature verified, and passed push-triggered CI
`35662990699` / R3 `35662990678`.

This unit adds the loopback binding: the Windows half of
`capture_windows_system_audio.rs` over the same adopted `cpal =0.18.2`
edge — `classify_error`, `config_from_supported`, `CpalLoopbackBackend`,
`LiveLoopbackStream`, and `open_f32_loopback_stream`. The stream is built
with `build_input_stream` on a *render* endpoint, which is precisely what
makes the closed binding set `AUDCLNT_STREAMFLAGS_LOOPBACK`; the
configuration comes from `default_output_config()` because
`default_input_config()` fails on render endpoints and shared-mode
loopback delivers the render mix format; and a non-F32 mix format is
refused as a build fault rather than converted. A Windows-only test
asserts that this classifier and the microphone classifier return the
same string for every cpal kind at both stages, so the two Windows
pathways cannot drift apart silently.

No manifest, lockfile, workflow, dependency, or donor byte changes. The
...
008C grain 1 is `CANONICAL_QUALIFIED` after a real CI failure and
forward repair: the first head `1bfc956` failed with a duplicate-endpoint
assertion (run `35667753768`, preserved), the repair head `91d3233`
passed pre-merge CI `35668523429` / R3 `35668523396` with ubuntu 7m28s,
macOS 5m16s, and windows 17m46s, merged as `89934e0` with parents
`39685d4` + `91d3233` and merge tree
`d2211751631c10993f568012d1ab519fa01edefe`, and passed post-merge CI
`35669970610` / R3 `35669970649`.

008C grain 2 adds `capture_windows_pressure.rs`: caller-supplied
`StorageBudgets`, an explicit `RefusalReason` set (critical storage, full
queue, and both together reported distinctly), a pure `decide_admission`
over the closed 006B classifier where warn-level pressure degrades rather
than refuses, zero queue capacity counting as full, and the
`checkpoint_due`/`advance_cadence_window` pair that carries the remainder
so time elapsed during a seal is never lost. With this grain the portable
