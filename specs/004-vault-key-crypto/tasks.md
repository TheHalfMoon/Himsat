...
- [ ] B305R003 Verify exact reconciliation parentage and exact push-triggered post-merge CI/R3 SUCCESS before B306 begins. Parentage is proven as `e27a0b2921af2661037b7af581f6be737c1352de` + `954948554b371d80d9473a155a48ea7f31edcdf7` with tree `b58acfdae5d9df89833d30413623130c80b67461`; post-merge R3 `34291064716` succeeded on attempt 1 while post-merge CI `34291064751` succeeded on attempt 1.
- [ ] B305X001 Canonicalize `b305-b306-transport-recovery-evidence.md`, this ledger, and the recovery-bound `specs/CURRENT.md` state through an exact-head qualified recovery PR without runtime/security/dependency/provenance/workflow changes.
- [ ] B305X002 Merge the exact recovery head only through an observed `expected_head_sha`-guarded merge request and record the accepted canonical merge result.
- [ ] B305X003 Verify exact recovery parentage plus exact push-triggered post-merge CI/R3 SUCCESS; only then may B306 begin.
