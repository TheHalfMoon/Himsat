...
- [ ] B304R001 Canonicalize `b304-integrity-final-evidence.md`, this task ledger, and the B305 re-bound `specs/CURRENT.md` state without security-semantic, dependency, provenance, generated-artifact, workflow, donor, or product-runtime changes.
- [ ] B304R002 Merge the exact B304/B305 reconciliation head only with explicit `expected_head_sha` protection and durable transport evidence.
- [ ] B304R003 Verify exact reconciliation parentage and exact push-triggered post-merge CI/R3 SUCCESS before B305 begins.
