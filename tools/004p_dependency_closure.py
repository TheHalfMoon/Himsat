...
EXPECTED_PLATFORM_PACKAGES: dict[tuple[str, str], dict[str, str]] = {
    ...
    ('ndk-sys', '0.6.0+11769913'): {
        ...
        "license_expression": 'MIT OR Apache-2.0',
        "selected_license": 'MIT',
        "license_evidence": 'upstream LICENSE-MIT at immutable VCS revision',
    },
    ('ndk-context', '0.1.1'): {
    ...
    ('block2', '0.6.2'): {
        ...
        "license_expression": 'MIT',
        "selected_license": 'MIT',
        "license_evidence": 'upstream LICENSE.md at immutable VCS revision',
    },
    ('bumpalo', '3.20.3'): {
    ...
    ('cpal', '0.18.2'): {
        ...
        "license_expression": 'Apache-2.0',
        "selected_license": 'Apache-2.0',
        "license_evidence": 'crate LICENSE at immutable VCS revision',
    },
    ('coreaudio-rs', '0.14.2'): {
    ...
    ('dispatch2', '0.3.1'): {
        ...
        "license_expression": 'Zlib OR Apache-2.0 OR MIT',
        "selected_license": 'MIT',
        "license_evidence": 'upstream LICENSE.md at immutable VCS revision',
    },
    ('dasp_sample', '0.11.0'): {
        "checksum": '0c87e182de0887fd5361989c677c4e8f5000cd9491d6d563161a8f3a5519fc7f',
        "repository": 'https://github.com/rustaudio/sample',
    ...
    ('mach2', '0.6.0'): {
        ...
        "license_expression": 'BSD-2-Clause OR MIT OR Apache-2.0',
        "selected_license": 'MIT',
        "license_evidence": 'crate LICENSE-MIT at immutable VCS revision',
    },
    ('memchr', '2.8.3'): {
    ...
    ('num_enum_derive', '0.7.6'): {
        ...
        "license_expression": 'BSD-3-Clause OR MIT OR Apache-2.0',
        "selected_license": 'MIT',
        "license_evidence": 'crate LICENSE-MIT at immutable VCS revision',
    },
    ('num_enum', '0.7.6'): {
    ...
    ('same-file', '1.0.6'): {
        ...
        "license_expression": 'Unlicense/MIT',
        "selected_license": 'MIT',
        "license_evidence": 'crate LICENSE-MIT at immutable VCS revision',
    },
